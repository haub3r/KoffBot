...
var appSettings = [
  ...
  }
  {
    ...
    value: '@Microsoft.KeyVault(SecretUri=https://koffbot-dev-kv.vault.azure.net/secrets/DbConnectionString/58f26df4602d4dce980d9c12378b4290)'
  }
  {
  ...
  {
    name: 'OpenAiApiKey'
    value: '@Microsoft.KeyVault(SecretUri=https://koffbot-dev-kv.vault.azure.net/secrets/OpenAiApiKey/3bd5534c5d9a4a1fa5dbcead2aa77363)'
  }
  {
    name: 'SlackSigningSecret'
    value: '@Microsoft.KeyVault(SecretUri=https://koffbot-dev-kv.vault.azure.net/secrets/SlackSigningSecret/83a746126ad44c62ab042e40c3f8aa38)'
  }
  {
    name: 'SlackWebHook'
